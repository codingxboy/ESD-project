...
public class MaterialExtend {
    ...
    public MaterialExtend(Long id, Long materialId, String barCode, String commodityUnit, String sku, BigDecimal purchaseDecimal, BigDecimal commodityDecimal, BigDecimal wholesaleDecimal, BigDecimal lowDecimal, String defaultFlag, Date createTime, String createSerial, String updateSerial, Long updateTime, String deleteFlag) {
        this.id = id;
