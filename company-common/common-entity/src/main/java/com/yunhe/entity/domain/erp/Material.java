...
public class Material {
    ...
    public Material(Long id, Long categoryId, String name, String mfrs, String model, String standard, String color, String unit, String remark, String imgName, Long unitId, Integer expiryNum, BigDecimal weight, Boolean enabled, String otherField1, String otherField2, String otherField3, String enableSerialNumber, String enableBatchNumber, String deleteFlag) {
        this.id = id;
