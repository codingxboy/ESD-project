package com.yunhe.common.core.result;
...
public enum ResultCode implements IResultCode, Serializable {
    ...
    USER_LOGIN_SUCCESS("A0212", "用户登录成功"),
    USER_REGISTERED_SUCCESS("A0217", "用户注册成功"),
    USER_DELETE_SUCCESS("A0218", "删除用户成功"),
    USER_LOGOUT_ERROR("A0213", "用户登出异常"),
    USER_ADD_ERROR("A0215", "添加用户异常"),
    USER_LOGOUT_SUCCESS("A0214", "用户登出成功"),
    USER_NOT_EXIST("A0201", "用户不存在"),
    USER_ACCOUNT_LOCKED("A0202", "用户账户被冻结"),
    USER_ACCOUNT_INVALID("A0203", "用户账户已作废"),
    LOGIN_NAME_ALREADY_EXISTS_IN_THE_SYSTEM("A0204","登录名在本系统已存在"),
    USER_NAME_ALREADY_EXISTS_IN_THE_SYSTEM("A0205","用户名在本系统已存在"),
    USER_NAME_LIMIT_USE_MSG("A0206","此用户名限制使用"),
    USERNAME_OR_PASSWORD_ERROR("A0210", "用户名或密码错误"),
    USER_RESET_PASSWORD_ERROR("A0212", "用户重置密码异常"),
    USER_RESET_PASSWORD_SUCCESS("A0216", "用户重置密码成功"),
    PASSWORD_ENTER_EXCEED_LIMIT("A0211", "用户输入密码次数超限"),

    CLIENT_AUTHENTICATION_FAILED("A0212", "客户端认证失败"),
    TOKEN_INVALID_OR_EXPIRED("A0230", "token无效或已过期"),
    TOKEN_ACCESS_FORBIDDEN("A0231", "token已被禁止访问"),
    AUTH_CODE_ERROR("A0232","获取验证码错误"),
    AUTH_CODE_SUCCESS("A0235","获取验证码成功"),
    SESSION_ERROR("A0234","获取用户session失败"),
    AUTH_CODE_INVALID("A0233","验证码无效"),
