package com.yunhe.auth.security.extension.refresh;
...
import com.yunhe.common.core.util.RequestUtils;
...
public class PreAuthenticatedUserDetailsService<T extends Authentication> implements AuthenticationUserDetailsService<T>, InitializingBean {
     ...
     *
     * @see com.yunhe.auth.security.config.AuthorizationServerConfig#tokenServices(AuthorizationServerEndpointsConfigurer)
     */
