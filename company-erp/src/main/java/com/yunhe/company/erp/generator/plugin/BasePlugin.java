package com.yunhe.company.erp.generator.plugin;

import com.yunhe.company.erp.generator.annotation.Annotation;
...
//        topLevelClass.addJavaDocLine("* 版权：青岛海豚数据技术有限公司");
        ...
        topLevelClass.addJavaDocLine("*");
        topLevelClass.addJavaDocLine("* @author jochen");
...
//        interfaze.addJavaDocLine("* 版权：青岛海豚数据技术有限公司");
        ...
        interfaze.addJavaDocLine("*");
        interfaze.addJavaDocLine("* @author jochen");
